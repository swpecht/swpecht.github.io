...
```
GET /bench/results?challenger_id=swpecht-google__gemini-3-flash-preview-20260524T222528Z&agent_name=<agent>
```
...
`/run/workspace` is a git clone of `https://forgejo.fewworddotrick.com/euchre-bench/euchre-google__gemini-3-flash-preview-20260524T222528Z`. Treat it as your
