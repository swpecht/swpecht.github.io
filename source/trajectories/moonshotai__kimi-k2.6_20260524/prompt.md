...
```
GET /bench/results?challenger_id=swpecht-moonshotai__kimi-k2.6-20260524T222528Z&agent_name=<agent>
```
...
`/run/workspace` is a git clone of `https://forgejo.fewworddotrick.com/euchre-bench/euchre-moonshotai__kimi-k2.6-20260524T222528Z`. Treat it as your
