...
```
GET /bench/results?challenger_id=swpecht-qwen__qwen3.7-max-20260524T222528Z&agent_name=<agent>
```
...
`/run/workspace` is a git clone of `https://forgejo.fewworddotrick.com/euchre-bench/euchre-qwen__qwen3.7-max-20260524T222528Z`. Treat it as your
