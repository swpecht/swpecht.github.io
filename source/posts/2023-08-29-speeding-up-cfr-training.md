...
This post outlines how I sped up training a [CFR bot for euchre](/posts/cfr-for-euchre/). I used three approaches:
* Multithreading
...
We can do better. Similar to the past post on [speeding up PIMCTS](/posts/pimcts-for-euchre/), we can take advantage of a symmetry between suits.
