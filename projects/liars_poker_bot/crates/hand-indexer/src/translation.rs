const MAX_GROUP_INDEX: usize = 1048576; // 0x100000
const MAX_CARDS_PER_ROUND: usize = 15;
const ROUND_SHIFT: usize = 4;
const ROUND_MASK: usize = 15; // 0xf
const RANKS: usize = 13; // todo check this
const SUITS: usize = 4;

struct HandIndexer {
    nth_unset: [[usize; RANKS]; 1 << RANKS],
    equal: [[usize; SUITS]; 1 << (SUITS - 1)],
    nCr_ranks: [[usize; RANKS]; RANKS],
}
