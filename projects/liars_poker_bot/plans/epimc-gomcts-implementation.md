...
| 38 | 2026-06-10 | **cfr3 vs cfr0 ceiling measurement** | difficulty bench, 50 matches | cfr3: 23-27 (46%), **49.0% pts** | cfr3 does NOT beat cfr0 in match play — the cfr depths are statistical equals head-to-head. So (a) our 48.1% bootstrap is already AT the cfr3-imitation ceiling, (b) beating cfr0 requires learning from games *against cfr0*, not better imitation of any cfr agent. → exploiter bootstrap (entry 39) |
