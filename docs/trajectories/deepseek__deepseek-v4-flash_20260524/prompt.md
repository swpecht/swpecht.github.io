...
```
GET /bench/results?challenger_id=swpecht-deepseek__deepseek-v4-flash-20260524T222528Z&agent_name=<agent>
```
...
`/run/workspace` is a git clone of `https://forgejo.fewworddotrick.com/euchre-bench/euchre-deepseek__deepseek-v4-flash-20260524T222528Z`. Treat it as your
