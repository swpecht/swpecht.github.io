...
```
GET /bench/results?challenger_id=swpecht-minimax__minimax-m2.7-20260524T222528Z&agent_name=<agent>
```
...
`/run/workspace` is a git clone of `https://forgejo.fewworddotrick.com/euchre-bench/euchre-minimax__minimax-m2.7-20260524T222528Z`. Treat it as your
